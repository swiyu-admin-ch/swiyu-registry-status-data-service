...
- Return HTTP 501 (Not Implemented) for requests to /api/v1/statuslist containing any query parameter, as no query parameter is supported (Token Status List specification)
